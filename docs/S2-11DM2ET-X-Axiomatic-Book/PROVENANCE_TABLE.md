...
| **539** | \(\sigma=N_{\mathrm{HQCC}}\) | 539 | **Mod** / **Cond** | **Not** derived from Res+Tower+Dem+ACE. No-go blocks deriving it from those data. |
...
| \(\lambda=\ln 3/539\) | \(\ln 3/\sigma\) | **Cond** | Circular if used to derive \(\sigma\) |
