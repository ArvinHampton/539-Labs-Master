...
- **RH pure Cat A track** (ZLA; ND1 locked; solid directions 1–6: Mass-with-A, StripDens, off-line resonance, density constants, finite products off-line, path from on-line Ω; B_θ/RH open): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF`
