...
- **RH pure Cat A track** (RH_L1, RH_M1, RH_M1_2, RH_O1, RH_Akatsuka_GHK_Survey.md, scripts/rh_L5_phase_diagnostic.py, scripts/rh_M1_2_remainder_diagnostic.py, scripts/rh_GHK_hybrid_diagnostic.py): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — L1; M1; M1.2 strategy+GHK form; Akatsuka–GHK survey; L5 + hybrid diagnostics; target lemma open
