...
- **RH pure Cat A track** (RH_L1, RH_M1, RH_O1_Akatsuka_M1_Package.md, RH_Akatsuka_Theorem_Extract.md, scripts/rh_L5_phase_diagnostic.py): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — L1; M1; O1 package; L5 large-\(x\) + \(\lvert\zeta\rvert\) minima (no RH claim)
