...
- **RH pure Cat A track** (ZLA; ND1 locked; solid directions: Mass-with-A, StripDens, off-line resonance, density constants; B_θ/RH open): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF`
