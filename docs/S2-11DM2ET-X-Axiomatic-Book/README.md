...
- **RH pure Cat A track** (ZLA; ND1 locked; density vs isolation; solid directions: density at moderate σ, Iso_H tech, path from on-line Ω, off-line resonance, Mass-with-A; B_θ/RH open): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — `RH_Density_vs_Isolation.md`
