...
> **Session claim freeze:** [`CLAIM_TABLE_Master.md`](CLAIM_TABLE_Master.md) | [`PUSH_LOG_2026-07-30_CuNc_Mirror.md`](PUSH_LOG_2026-07-30_CuNc_Mirror.md)
...
- **Master claim table** (`CLAIM_TABLE_Master.md`) — 2026-07-30 CuNc + mirror freeze
- **Executive summaries** (`Executive_Summary_2026-07-29.md`, `Executive_Summary_2026-07-30.md`, `Executive_Summary_2026-07-30_CuNc_Mirror.md`)
...
- **Muon g−2 Path A** (`Muon_g2_Oscillatory_Resolution_2026-07-30.md`) — PRIMARY
- **CuNc 2026 FS audit** (`CuNc_2026_Exciton_Imaging_Audit.md`) — T₂ ≈ 70 fs; **2.3 fs RETRACTED**
- **E_leak CuNc numerical patch** (`E_leak_CuNc_Numerical_Patch.md`)
- **−Periodic Table / mirror halo** (`Mirror_Periodic_Table_Halo_Extension.md`) — **Cat B only**
- Machine results: `cunC_2026_audit_results.json`
...
| G_4 | 539.90 s | Emp/Mod hypothesis |
| CuNc T₂ (monomer) | ≈ 70 fs | External data (Luo et al. 2026) |
| CuNc draft 2.3 fs | — | **RETRACTED** |
