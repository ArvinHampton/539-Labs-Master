...
- **9 Maths pattern exploration** (`Nine_Maths_Pattern_Exploration.md`): Hopf / Faddeev–Niemi / Cartan-torsion vs TTC–RTTC (strongest), RNT and BMMT/HMT (secondary); residual carrier as discrete skeleton only; continuum claims Category B; Option 3 / No-Go intact
