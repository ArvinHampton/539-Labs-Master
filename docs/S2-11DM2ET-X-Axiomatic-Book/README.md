...
- **RH pure Cat A track** (RH_L1_Phase_Functional_CatA.md, RH_Akatsuka_Theorem_Extract.md, RH_Target_Lemma_Sketch_Literature_L5.md): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — L1; exact Akatsuka extract; target lemma open
