...
- **RH pure Cat A track** (RH_L1, RH_M1, RH_M1_2_Remainder_Bound_Strategy.md, RH_O1, scripts/rh_L5_phase_diagnostic.py, scripts/rh_M1_2_remainder_diagnostic.py): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — L1; M1; M1.2 strategy+diagnostic; L5; target lemma open
