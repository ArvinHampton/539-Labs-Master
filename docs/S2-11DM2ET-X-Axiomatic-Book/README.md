...
- **RH pure Cat A track** (RH_L1_Phase_Functional_CatA.md, RH_Debt_Argument_Status.md): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — open/active; L1 \(A_X\) formalized; target lemma open; no model constants in theorems
