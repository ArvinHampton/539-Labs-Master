...
- **RH pure Cat A track** (RH_L1_Phase_Functional_CatA.md, RH_Target_Lemma_Sketch_Literature_L5.md, RH_Debt_Argument_Status.md): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — L1 formalized; target-lemma sketch (Akatsuka→arg); L5 plan; literature citations
