...
- **RH pure Cat A track** (ZLA; ND1 locked; Iso_H classical constraints; preferred next Mass-with-A; O-TL/B_θ/RH open): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — `RH_ND1_Stability_Resolve.md`, `RH_Iso_H_Classical_Constraints.md`
