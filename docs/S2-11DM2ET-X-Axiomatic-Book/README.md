...
- **RH pure Cat A track** (ZLA; ND1 locked; finite products/Ivić/Mass-A criteria; preferred next polylog \(A\); B_θ/RH open): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — `RH_Finite_Product_Ivic_MassA.md`, `RH_ND1_Stability_Resolve.md`
