...
- **RH pure Cat A track** (ZLA; ND1: (RM)+(Iso_H)⇒B_θ proved; on-line Omega accepted; solid directions + (Iso_H) barrier; O-TL/B_θ unconditional open): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — `RH_ND1_Stability_Resolve.md`, `RH_Existing_Theorems_Solid_Directions.md`
