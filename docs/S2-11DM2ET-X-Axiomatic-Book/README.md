...
- **RH pure Cat A track** (`RH_Research_Paths_Execution_Report.md`, `scripts/rh_research_batch.py`, M1.4, L4, optimized \(c_i\), GHK/M1.3): `RH_OPEN_DEBT_ARGUMENT_NOT_A_PROOF` — all executable research paths run; **RH / target lemma open**
